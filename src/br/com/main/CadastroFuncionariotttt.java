...
public class CadastroFuncionariotttt extends javax.swing.JInternalFrame {
	...
	public CadastroFuncionariotttt(boolean demissao, Funcionario funcionario) {
		...
		jbtAlterar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Integer codigo = Integer.valueOf((String) dtmLista.getValueAt(
						linha, 0));
				dispose();
				new CadastroFuncionariotttt(true, funcionarioDAO.buscar(codigo));
